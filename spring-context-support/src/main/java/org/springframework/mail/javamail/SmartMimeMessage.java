...
/**
 * Special subclass of the standard JavaMail {@link MimeMessage}, carrying a default
 * encoding to be used when populating the message and a default Java Activation
 * {@link FileTypeMap} to be used for resolving attachment types.
 *
 * <p>
 * Created by {@link JavaMailSenderImpl} in case of a specified default encoding and/or
 * default FileTypeMap. Autodetected by {@link MimeMessageHelper}, which will use the
 * carried encoding and FileTypeMap unless explicitly overridden.
 *
