...
class CacheRemoveOperation extends AbstractJCacheKeyOperation<CacheRemove> {
	...
	public CacheRemoveOperation(CacheMethodDetails<CacheRemove> methodDetails,
		...
		this.exceptionTypeFilter = createExceptionTypeFilter(ann.evictFor(),
				ann.noEvictFor());
	}
	...
	/**
	 * Specify if the cache entry should be remove before invoking the method. By default,
	 * the cache entry is removed after the method invocation.
	 * 
