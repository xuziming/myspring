...
class CacheResultOperation extends AbstractJCacheKeyOperation<CacheResult> {
	...
	public CacheResultOperation(CacheMethodDetails<CacheResult> methodDetails,
		...
		this.exceptionTypeFilter = createExceptionTypeFilter(ann.cachedExceptions(),
				ann.nonCachedExceptions());
		this.exceptionCacheResolver = exceptionCacheResolver;
		this.exceptionCacheName = (StringUtils.hasText(ann.exceptionCacheName())
				? ann.exceptionCacheName()
				: null);
	}
