...
/**
 * {@link FactoryBean} for a JCache {@link javax.cache.CacheManager}, obtaining a
 * pre-defined CacheManager by name through the standard JCache
 * {@link javax.cache.Caching} class.
 *
 * <p>
 ...
 */
public class JCacheManagerFactoryBean implements FactoryBean<CacheManager>,
	...
	/**
	 * Specify the URI for the desired CacheManager. Default is {@code null} (i.e.
	 * JCache's default).
	 */
	...
	/**
	 * Specify properties for the to-be-created CacheManager. Default is {@code null}
