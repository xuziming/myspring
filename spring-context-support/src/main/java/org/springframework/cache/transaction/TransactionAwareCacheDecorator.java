 ...
 *
 * <p>
 * Use of more aggressive operations such as {@link #putIfAbsent} cannot be deferred to
 * the after-commit phase of a running transaction. Use these with care.
 *
			...
			TransactionSynchronizationManager.registerSynchronization(
					new TransactionSynchronizationAdapter() {
						...
						public void afterCommit() {
							TransactionAwareCacheDecorator.this.targetCache.put(key,
									value);
						}
					});
		}
