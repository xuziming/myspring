...
/**
 * {@link CacheManager} implementation that lazily builds {@link GuavaCache} instances for
 * each {@link #getCache} request. Also supports a 'static' mode where the set of cache
 * names is pre-defined through {@link #setCacheNames}, with no dynamic creation of
 * further cache regions at runtime.
 *
 * <p>
 * The configuration of the underlying cache can be fine-tuned through a Guava
 * {@link CacheBuilder} or {@link CacheBuilderSpec}, passed into this CacheManager through
 * {@link #setCacheBuilder}/{@link #setCacheBuilderSpec}. A
 * {@link CacheBuilderSpec}-compliant expression value can also be applied via the
...
public class GuavaCacheManager implements CacheManager {
	...
	/**
	 * Construct a dynamic GuavaCacheManager, lazily creating cache instances as they are
	 * being requested.
	 */
	...
	/**
	 * Construct a static GuavaCacheManager, managing caches for the specified cache names
	 * only.
	 */
	...
	/**
	 * Set the Guava CacheBuilder to use for building each individual {@link GuavaCache}
	 * instance.
	 * 
	...
	/**
	 * Set the Guava cache specification String to use for building each individual
	 * {@link GuavaCache} instance. The given value needs to comply with Guava's
	 * {@link CacheBuilderSpec} (see its javadoc).
	 * 
	 * @see #createNativeGuavaCache
	...
	/**
	 * Set the Guava CacheLoader to use for building each individual {@link GuavaCache}
	 ...
	 * cache manager.
	 * <p>
	 * Default is "true", despite Guava itself not supporting {@code null} values. An
