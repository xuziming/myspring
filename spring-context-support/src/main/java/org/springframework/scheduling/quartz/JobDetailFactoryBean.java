 ...
 */
public class JobDetailFactoryBean implements FactoryBean<JobDetail>, BeanNameAware,
	 ...
	 * 
	 * @param jobDataAsMap Map with String keys and any objects as values (for example
