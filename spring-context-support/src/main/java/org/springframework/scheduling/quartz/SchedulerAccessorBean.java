...
public class SchedulerAccessorBean extends SchedulerAccessor
	...
	public void afterPropertiesSet() throws SchedulerException {
		if (this.scheduler == null) {
			this.scheduler = (this.schedulerName != null
					? findScheduler(this.schedulerName)
	...
	protected Scheduler findScheduler(String schedulerName) throws SchedulerException {
		...
		Scheduler schedulerInRepo = SchedulerRepository.getInstance().lookup(
				schedulerName);
		if (schedulerInRepo == null) {
			throw new IllegalStateException(
					"No Scheduler named '" + schedulerName + "' found");
		}
