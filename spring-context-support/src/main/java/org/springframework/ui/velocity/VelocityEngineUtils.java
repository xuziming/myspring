...
/**
 * Utility class for working with a VelocityEngine. Provides convenience methods to merge
 * a Velocity template with a model.
 *
...
public abstract class VelocityEngineUtils {
	...
	/**
	 * Merge the specified Velocity template with the given model and write the result to
	 * the given Writer.
	 * 
	 * @param velocityEngine VelocityEngine to work with
	 * @param templateLocation the location of template, relative to Velocity's resource
	 *        loader path
	...
	public static void mergeTemplate(VelocityEngine velocityEngine,
			String templateLocation, Map<String, Object> model, Writer writer)
	 ...
	 * <p>
	 * When using this method to prepare a text for a mail to be sent with Spring's mail
	 * support, consider wrapping VelocityException in MailPreparationException.
	 * 
	 * @param velocityEngine VelocityEngine to work with
	 * @param templateLocation the location of template, relative to Velocity's resource
	 *        loader path
	 ...
	 * @deprecated Use
	 *             {@link #mergeTemplateIntoString(VelocityEngine, String, String, Map)}
	 *             instead, following Velocity 1.6's corresponding deprecation in its own
	 *             API.
	 */
	@Deprecated
	public static String mergeTemplateIntoString(VelocityEngine velocityEngine,
			String templateLocation, Map<String, Object> model) throws VelocityException {
