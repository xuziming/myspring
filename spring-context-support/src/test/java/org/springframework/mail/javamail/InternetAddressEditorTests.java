...
public class InternetAddressEditorTests {
	...
	public void uninitialized() {
		assertEquals("Uninitialized editor did not return empty value string", EMPTY,
				editor.getAsText());
	}
	...
	public void setNull() {
		...
		assertEquals("Setting null did not result in empty value string", EMPTY,
				editor.getAsText());
	}
	...
	public void setEmpty() {
		...
		assertEquals("Setting empty string did not result in empty value string", EMPTY,
				editor.getAsText());
	}
