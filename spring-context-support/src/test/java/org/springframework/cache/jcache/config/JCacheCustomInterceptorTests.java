...
public class JCacheCustomInterceptorTests {
	...
	public void onlyOneInterceptorIsAvailable() {
		Map<String, JCacheInterceptor> interceptors = ctx.getBeansOfType(
				JCacheInterceptor.class);
		...
		assertEquals("Custom interceptor not defined", TestCacheInterceptor.class,
	...
	static class EnableCachingConfig {
		...
		@Bean
		public JCacheInterceptor jCacheInterceptor(
	...
	/**
	 * A test {@link org.springframework.cache.interceptor.CacheInterceptor} that handles
