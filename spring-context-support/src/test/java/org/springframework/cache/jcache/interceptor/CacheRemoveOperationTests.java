 ...
 */
public class CacheRemoveOperationTests
		extends AbstractCacheOperationTests<CacheRemoveOperation> {
	...
	protected CacheRemoveOperation createSimpleOperation() {
		...
		return new CacheRemoveOperation(methodDetails, defaultCacheResolver,
				defaultKeyGenerator);
	}
