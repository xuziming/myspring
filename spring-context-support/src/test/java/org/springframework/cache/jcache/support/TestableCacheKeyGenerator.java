...
/**
 * A simple test key generator that only takes the first key arguments into account. To be
 * used with a multi parameters key to validate it has been used properly.
 *
...
public class TestableCacheKeyGenerator implements CacheKeyGenerator {
	...
	private static class SimpleGeneratedCacheKey extends SimpleKey
