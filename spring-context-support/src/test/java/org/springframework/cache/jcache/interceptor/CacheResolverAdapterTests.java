...
public class CacheResolverAdapterTests extends AbstractJCacheTests {
	...
	public void resolveSimpleCache() throws Exception {
		...
		CacheResolverAdapter adapter = new CacheResolverAdapter(
				getCacheResolver(dummyContext, "testCache"));
	...
	public void resolveUnknownCache() throws Exception {
		DefaultCacheInvocationContext<?> dummyContext = createDummyContext();
		CacheResolverAdapter adapter = new CacheResolverAdapter(
				getCacheResolver(dummyContext, null));
	...
	protected DefaultCacheInvocationContext<?> createDummyContext() throws Exception {
		...
		CacheMethodDetails<CacheResult> methodDetails = new DefaultCacheMethodDetails<>(
				method, cacheAnnotation, "test");
		...
		return new DefaultCacheInvocationContext<>(operation, new Sample(),
				new Object[] { "id" });
	}
