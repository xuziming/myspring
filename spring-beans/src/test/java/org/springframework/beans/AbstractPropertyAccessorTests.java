...
public abstract class AbstractPropertyAccessorTests {
	...
	public void setNestedPropertyPolymorphic() throws Exception {
		...
		assertTrue("spouse.spouse.spouse.spouse.company=Lewisham", "Lewisham".equals(
				kerryAccessor.getPropertyValue("spouse.spouse.spouse.spouse.company")));
	}
	...
	public void setAnotherPropertyIntermediatePropertyIsNull() throws Exception {
		...
		try {
			...
			// expected
			assertTrue(
					"it was the spouse property that was null, not "
							+ ex.getPropertyName(),
	...
	public void setValidPropertyValues() {
		...
		try {
			...
			assertTrue("Name property should have changed",
					target.getName().equals(newName));
			assertTrue("Touchy property should have changed",
					target.getTouchy().equals(newTouchy));
	...
	public void setBooleanProperty() {
		...
		assertTrue("Correct bool2 value",
				Boolean.TRUE.equals(accessor.getPropertyValue("bool2")));
		assertTrue("Correct bool2 value", target.getBool2());

		accessor.setPropertyValue("bool2", "false");
		assertTrue("Correct bool2 value",
				Boolean.FALSE.equals(accessor.getPropertyValue("bool2")));
		assertTrue("Correct bool2 value", !target.getBool2());
	}
	...
	public void setNumberProperties() {
		...
		assertTrue("Correct short2 value",
				new Short("2").equals(accessor.getPropertyValue("short2")));
		assertTrue("Correct short2 value", new Short("2").equals(target.getShort2()));
		assertTrue("Correct int2 value",
				new Integer("8").equals(accessor.getPropertyValue("int2")));
		assertTrue("Correct int2 value", new Integer("8").equals(target.getInt2()));
		assertTrue("Correct long2 value",
				new Long("6").equals(accessor.getPropertyValue("long2")));
		assertTrue("Correct long2 value", new Long("6").equals(target.getLong2()));
		assertTrue("Correct bigInteger value",
				new BigInteger("3").equals(accessor.getPropertyValue("bigInteger")));
		assertTrue("Correct bigInteger value",
				new BigInteger("3").equals(target.getBigInteger()));
		assertTrue("Correct float2 value",
				new Float("8.1").equals(accessor.getPropertyValue("float2")));
		assertTrue("Correct float2 value", new Float("8.1").equals(target.getFloat2()));
		assertTrue("Correct double2 value",
				new Double("6.1").equals(accessor.getPropertyValue("double2")));
		assertTrue("Correct double2 value",
				new Double("6.1").equals(target.getDouble2()));
		assertTrue("Correct bigDecimal value",
				new BigDecimal("4.0").equals(accessor.getPropertyValue("bigDecimal")));
		assertTrue("Correct bigDecimal value",
	...
	public void setStringArrayProperty() throws Exception {
		...
		accessor.setPropertyValue("stringArray",
				new String[] { "foo", "fi", "fi", "fum" });
		assertTrue("stringArray length = 4", target.stringArray.length == 4);
		assertTrue("correct values",
				target.stringArray[0].equals("foo") && target.stringArray[1].equals("fi")
						&& target.stringArray[2].equals("fi")
						&& target.stringArray[3].equals("fum"));
		...
		assertTrue("correct values", result.contains("foo") && result.contains("fi")
				&& result.contains("fum"));
	...
	public void setStringArrayPropertyWithCustomStringEditor() throws Exception {
		PropsTester target = new PropsTester();
		AbstractPropertyAccessor accessor = createAccessor(target);
		accessor.registerCustomEditor(String.class, "stringArray",
	...
	public void setStringArrayPropertyWithStringSplitting() throws Exception {
		...
		assertTrue("correct values",
				target.stringArray[0].equals("a1") && target.stringArray[1].equals("b2"));
	}
	...
	public void setStringArrayWithAutoGrow() throws Exception {
		...
		assertTrue("correct values", target.getArray()[0].equals("Test0")
				&& target.getArray()[1] == null && target.getArray()[2].equals("Test2"));
	}
	...
	public void setIntArrayProperty() {
		...
		assertTrue("correct values", result.contains(new Integer(4))
				&& result.contains(new Integer(5)) && result.contains(new Integer(3)));
	...
	public void setPrimitiveArrayPropertyLargeMatching() {
		...
		accessor.registerCustomEditor(int.class, "array.somePath",
		...
		accessor.registerCustomEditor(int.class, "array[0].somePath",
				new CustomNumberEditor(Integer.class, false));
		sw.start("array3");
		for (int i = 0; i < 1000; i++) {
			accessor.setPropertyValue("array", input);
		...
		accessor.registerCustomEditor(int.class,
				new CustomNumberEditor(Integer.class, false));
		sw.start("array4");
		for (int i = 0; i < 100; i++) {
			accessor.setPropertyValue("array", input);
	...
	public void setPrimitiveArrayPropertyWithAutoGrow() throws Exception {
		...
		assertEquals(3, target.getArray().length);
		assertTrue("correct values", target.getArray()[0] == 1
				&& target.getArray()[1] == 0 && target.getArray()[2] == 3);
	}
	...
	@SuppressWarnings("unchecked") // list cannot be properly parameterized as it breaks
									// other tests
	@Test
	...
	public void setCollectionPropertyWithStringValueAndCustomEditor() {
		IndexedTestBean target = new IndexedTestBean();
		AbstractPropertyAccessor accessor = createAccessor(target);
		accessor.registerCustomEditor(String.class, "set",
				new StringTrimmerEditor(false));
		accessor.registerCustomEditor(String.class, "list",
				new StringTrimmerEditor(false));
	...
	public void setUnknownProperty() {
		...
		try {
			...
			assertEquals("Invalid number of possible matches", 1,
					e.getPossibleMatches().length);
	...
	public void propertyTypeDescriptor() {
		...
		assertThat(accessor.getPropertyTypeDescriptor("address.city"),
				is(notNullValue()));
	}
	...
	public void propertyTypeIndexedProperty() {
		...
		accessor = createAccessor(target);
		accessor.registerCustomEditor(String.class, "map[key0]",
				new StringTrimmerEditor(false));
		assertEquals(String.class, accessor.getPropertyType("map[key0]"));
	}
