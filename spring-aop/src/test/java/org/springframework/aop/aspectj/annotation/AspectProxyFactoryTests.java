...
public class AspectProxyFactoryTests {
	...
	public void testWithInstance() throws Exception {
		...
		ITestBean serializedProxy = (ITestBean) SerializationTestUtils.serializeAndDeserialize(
				proxy);
	...
	public static class LoggingAspectOnVarargs implements Serializable {
		...
		public Object doLog(ProceedingJoinPoint pjp) throws Throwable {
			LogFactory.getLog(LoggingAspectOnVarargs.class).debug(
	...
	public static class LoggingAspectOnSetter {
		...
		public Object doLog(ProceedingJoinPoint pjp) throws Throwable {
			LogFactory.getLog(LoggingAspectOnSetter.class).debug(
					Arrays.asList(pjp.getArgs()));
			return pjp.proceed();
		}
	}
